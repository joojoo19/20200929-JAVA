...
public class BitOperator {
	public static void main(String[] args) {
	    ...
	    // >> : 각 bit를 오른쪽으로 옮김, 왼쪽은 msb(most significant) 최상위 비트로 채움. +일때는 0으로채우고 -일때는 1로 채움.
	    // >>> : 각 bit를 오른쪽으로 옮김, 왼쪽은 무조건 0으로 채움.
	    
	    int val = 98; // 0000 0000 0000 0000 0000 0000 0000 00001
	    int res = val << 2; // val이 가지고 있는 값에 1을 한 칸씩 왼쪽으로 옮김. (x2한 것과 같음)
	    System.out.println(res); // <<2 x4한 것과 같음. <<3 x8한 것과 같음.
	    
	    val = 16; // >>1 /2와 같음. >>2 /4와 같음. >>3 /8과 같음
	    res = val >>1;
